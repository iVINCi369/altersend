...
import { Button, ExternalLink, SegmentedProgress, ThemeType, useTheme } from '@ruqa/components'
import { onboardingSlides, type OnboardingSlideKind } from '@ruqa/domain'
  ...
  return (
    <main className='flex h-screen w-full flex-col overflow-hidden bg-background text-text-primary'>
      ...
      <div className='flex shrink-0 justify-center px-8'>
        <img src={brandLogo} alt='Ruqa' className='h-8 w-auto object-contain' />
      </div>
